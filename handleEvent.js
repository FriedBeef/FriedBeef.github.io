import { showTriangle } from './showTriangle.js';
...
export function handleEvent(svg, width, height, event, instructions, adjSet, innerTrianglesCoordinates, t, outerTriangle, trianglesList) {
    switch(state) {
        case 0:
        ...
        case 3: // Remove vertices and edges
            ...
            svg.selectAll("*").remove();
            showTriangle(svg, outerTriangle);
        ...
        case 4: // Earcut
            if (trianglesCoordinates.length==0) {
                ...
                ({ trianglesCoordinates, adjSet} = ec(holes, trianglesCoordinates, adjSet));
